...
export const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { verbs: "toss · walls · bump", text: "Things that keep moving after you let go. toss() keeps the flick's velocity and slows by its friction; where it stops is where it rests, and drift picks up again there. walls() makes the screen's edges something to come back off. bump() on a group makes its members push each other, a small one bouncing off a big one that barely moves. Throw them around.", code: `a: circle(120, "sky").at(40, 120)\nb: circle(90, "plum").at(230, 260)\nc: circle(140, "mint").at(90, 480)\nd: circle(70, "coral").at(260, 600)\nthings: group(a, b, c, d)\nthings.drift(10).drag().toss(.3).walls()\nthings.bump()` },
